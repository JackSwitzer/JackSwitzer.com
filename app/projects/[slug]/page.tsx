        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {project.github && (
            <a
              ...
              className="tag inline-flex items-center gap-1 bg-[var(--ink)] text-[var(--paper)] hover:opacity-90 transition-opacity"
            >
          ...
          {project.link && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="tag inline-flex items-center gap-1 border border-[var(--border)] bg-transparent hover:border-[var(--accent)] hover:text-[var(--accent)] transition-colors"
            >
