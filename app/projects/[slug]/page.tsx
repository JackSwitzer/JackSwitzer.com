            ...
            <div className="flex flex-col gap-1.5">
              {project.github && (
                <a
                  ...
                  className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 bg-[var(--ink)] text-[var(--paper)] text-xs font-mono uppercase tracking-wide hover:opacity-90 transition-opacity min-w-[90px]"
                >
              ...
              {project.link && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 border border-[var(--border)] text-xs font-mono uppercase tracking-wide hover:border-[var(--accent)] hover:text-[var(--accent)] transition-colors min-w-[90px]"
                >
