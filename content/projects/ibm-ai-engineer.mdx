---
title: "IBM AI Engineer - Mainframe Code Assistant"
projectType: work
technologies:
  - Python
  - TypeScript
...
# IBM AI Engineer - Mainframe Code Assistant

A 12-month internship at IBM (May 2025 - April 2026) building AI tooling for Mainframe Code Assistant, enabling enterprise mainframe code understanding and modernization.
...
This work directly contributes to IBM's Mainframe Code Assistant, helping enterprises understand, maintain, and modernize their mainframe systems while enabling the next generation of developers to work with legacy code effectively.
