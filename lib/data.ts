...
export const experience = [
  ...
  },
  {
    ...
    accomplishments: [
      ...
      "Created learning platform (apsc174.jackswitzer.com) with interactive visualizations",
    ],
...
export const extracurriculars = [
  {
    ...
    accomplishments: [
      "Led IBM's intern student council as President from July to January",
  ...
  },
  {
    ...
    period: "2023-2025",
    accomplishments: [
      "Progressed from analyst to project manager in Queen's premier quantitative finance club",
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    accomplishments: [
      ...
      "Trained behavioral cloning model on 77 million official game runs",
